  ...
  },
  {
    ...
    prompt: () =>
      [
        ...
        '',
        'Call get_diagnostics, read the actual errors, and find the cause — not just the line',
        'the error points at. Fix it, then run a build and report what the build actually said.',
        'If you cannot reproduce or fix a problem, say so plainly rather than guessing.',
      ].join('\n'),
  },
  {
    id: 'tests',
  ...
  },
  {
    ...
    prompt: () =>
      [
        ...
        '',
        'Read the files that changed and look for real defects: incorrect logic, unhandled',
        'errors, security problems, missing cases. Report what you find with file paths and',
        'line numbers, ordered by how much it matters. Do not edit anything — this is a review.',
        'If the changes look correct, say so instead of inventing findings.',
      ].join('\n'),
  },
  {
    id: 'optimize',
